...
Hart<URV>::execRotleft(const DecodedInst* di)
{
  ...
  int32_t wordl = int32_t(intRegs_.read(di->op1()) << shift);
  int32_t wordr = int32_t(intRegs_.read(di->op1()) >> (32-shift));
  URV v = wordl|wordr;
  intRegs_.write(di->op0(), v);
}
...
Hart<URV>::execReverse(const DecodedInst* di)
{
  /* INSERT YOUR CODE  HERE */ 
  uint32_t shift = intRegs_.read(di->op2()) & 0x1f;
  int32_t word1 = int32_t(intRegs_.read(di->op1()) >> (24-shift*8));
  URV v = word1&0x000000ff;
  intRegs_.write(di->op0(), v);
}
...
inline
void
Hart<URV>::execLeftadd(const DecodedInst* di)
{
  int32_t word2 = int32_t(intRegs_.read(di->op1()));
  int32_t word1 = int32_t(word2 << 2);
  word2 = int32_t(word1 + intRegs_.read(di->op2()));
  URV v = word2;
  intRegs_.write(di->op0(), v);
}
...
inline
void
Hart<URV>::execRightadd(const DecodedInst* di)
{
  int32_t word2 = int32_t(intRegs_.read(di->op1()));
  int32_t word1 = int32_t(word2 >> 31);
  word1 = int32_t(word1 + intRegs_.read(di->op2()));
  word2 = int32_t(word1 + word2);
  URV v = word2;
  intRegs_.write(di->op0(), v);
}
...
inline
void
Hart<URV>::execRadd1(const DecodedInst* di)
{
