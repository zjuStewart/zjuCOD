...
/* INSERT YOUR CODE FROM HERE */  
  else if(funct7 == 2)
    {
      ...
      if (funct3 == 5) return instTable_.getEntry(InstId::leftadd);
      if (funct3 == 6) return instTable_.getEntry(InstId::rightadd);
      if (funct3 == 7) return instTable_.getEntry(InstId::radd1);
    }
