...
/* INSERT YOUR CODE FROM HERE */
    ...
    /// Encode "Leftadd rd, rs1, rs2" into this object.
    bool encodeLeftadd(unsigned rd, unsigned rs1, unsigned rs2);

    /// Encode "Rightadd rd, rs1, rs2" into this object.
    bool encodeRightadd(unsigned rd, unsigned rs1, unsigned rs2);

    /// Encode "Radd1 rd, rs1, rs2" into this object.
    bool encodeRadd1(unsigned rd, unsigned rs1, unsigned rs2);
