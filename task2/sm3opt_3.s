...
sm3_group_a:
	...
	xor	a4,a4,a5
	lw	a5,-32(s0)
    li  a6,15#can be changed
	.insn r 0x33,1,2,a5,a5,a6 #rotleft
	#slli	a3,a5,15
	#srli	a5,a5,17
	#or	a5,a5,a3
	xor	a4,a4,a5
	...
	xor	a5,a3,a5
    li  a6,9
	.insn r 0x33,2,2,a5,a5,a6 #rotright
	#srli	a3,a5,9
	#slli	a5,a5,23
	#or	a5,a5,a3
	xor	a4,a4,a5
...
.L36:
	...
	add	a5,a5,a4
    li  a6,7
	.insn r 0x33,1,2,a4,a5,a6 #rotleft
	#slli	a2,a5,7
	#srli	a4,a5,25
	#or	a4,a4,a2
	lw	a5,-572(s0)
...
.L38:
    ...
    lw	a3,-556(s0)
	lw	a5,-548(s0)
	.insn r 0x33,4,2,a5,a3,a5#notand
	#lw	a5,-556(s0)
	#not	a3,a5
	#lw	a5,-548(s0)
	#and	a5,a3,a5
